 ...
 *
 * All mutations are immutable â€” each method returns a new session.
 */
 ...
 * - R3: deterministic â€” same state + same decision â†’ same result.
 * - R4: rollback-safe â€” invalid decisions leave session untouched.
 */
