...
export class FederatedWatchdog extends EventEmitter {
  ...
  constructor(
    ...
    this.leaseMgr = new LeaseManager(this.clock, opts.nodeId, 30_000);
    this.termMgr = new TermManager(this.clock);
    this.faultGov = new FaultGovernor();
    this.pruner = new NodePruner(this.clock, 30_000, this.faultGov);
