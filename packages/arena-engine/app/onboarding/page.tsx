...
export default function TruthTunnelPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-primary)] flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
      {/* Background Decor */}
          ...
          {step === "upload" && (
            ...
            >
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-7xl font-semibold tracking-[-0.03em] leading-[0.9]">
                  Déposez votre CV.
                </h1>
              ...
              <div
                className="border-2 border-dashed border-[var(--border)] rounded-[3.5rem] p-20 bg-[var(--bg-card)] hover:bg-white/[0.04] transition-all cursor-pointer group relative overflow-hidden"
              ...
              >
                ...
                {loading ? (
                  <div className="space-y-6">
                    <Loader2 className="w-16 h-16 text-[var(--primary)] animate-spin mx-auto" />
                    <p className="text-xs font-medium tracking-[1.5px] uppercase text-blue-400 animate-pulse">
                      Extraction de vos capacités...
                    </p>
                  </div>
                ) : (
                  <div className="space-y-6">
                    <div className="w-24 h-24 bg-white/5 rounded-[var(--radius-card)] flex items-center justify-center mx-auto group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500 border border-[var(--border)] shadow-2xl">
                      <Upload className="w-10 h-10 text-[var(--text-secondary)] group-hover:text-[var(--primary)] transition-colors" />
                    </div>
                    <p className="text-sm font-black uppercase tracking-[0.3em] text-[var(--text-secondary)] group-hover:text-[var(--text-primary)] transition-colors">
                      PDF ou DOCX accepté
                    </p>
                  </div>
                )}
          ...
          {step === "job" && (
            ...
            >
              <div className="text-center space-y-6">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-[var(--bg-card)] border border-[var(--border)] rounded-lg">
                  <ShieldCheck className="w-4 h-4 text-[var(--primary)]" />
                  <span className="text-xs font-medium text-[var(--primary)] uppercase tracking-widest">
                    CV Analysé avec succès
                  </span>
                </div>
                <h2 className="text-3xl lg:text-4xl font-black italic text-[var(--text-primary)] leading-tight">
              ...
              <div className="bg-[var(--bg-card)] rounded-[3.5rem] border border-[var(--border)] p-12 shadow-2xl relative">
                <UniversalJobInput
          ...
          {step === "truth" && (
            ...
            >
              <div className="text-center space-y-4">
                <h2 className="text-4xl lg:text-6xl font-black tracking-tight leading-none text-[var(--text-primary)]">
              ...
              <div className="bg-white rounded-[3.5rem] p-12 space-y-12 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.5)]">
                <div className="space-y-8 text-left">
                  <div className="flex gap-6 items-start">
                    <div className="w-14 h-14 rounded-[var(--radius-card)] bg-blue-50 flex items-center justify-center text-blue-600 shrink-0 shadow-sm border border-blue-100">
                  ...
                  <div className="flex gap-6 items-start">
                    <div className="w-14 h-14 rounded-[var(--radius-card)] bg-rose-50 flex items-center justify-center text-rose-600 shrink-0 shadow-sm border border-rose-100">
                ...
                <div className="p-10 bg-slate-950 rounded-[2.5rem] text-[var(--text-primary)] space-y-5 relative overflow-hidden group">
                  <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
                    <UserCheck className="w-32 h-32" />
                  </div>
                  <p className="text-xs font-medium text-blue-400 uppercase tracking-[0.4em] relative z-10">
                    Action Recommandée
                  </p>
                ...
                <div className="pt-6 flex flex-col gap-6">
                  <Button
                    ...
                    size="lg"
                    className="h-24 px-12 rounded-[var(--radius-card)] bg-blue-600 hover:bg-blue-700 text-[var(--text-primary)] font-black text-2xl shadow-[0_25px_50px_-12px_rgba(37,99,235,0.5)] transition-all hover:scale-105 active:scale-95 group"
                  >
                    S'entraîner à lever ce doute{" "}
                    <ArrowRight className="ml-3 w-8 h-8 group-hover:translate-x-2 transition-transform" />
                  </Button>
                  <p className="text-center text-xs font-medium text-[var(--text-secondary)] uppercase tracking-[0.3em] flex items-center justify-center gap-3">
