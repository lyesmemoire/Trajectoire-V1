...
|----------|------|------------------|--------------|
| mutation-report.json | mutation | `sha256:dcb0f2f01bb98...` | ❌ |
| coverage-report.json | coverage | `sha256:c4cfc33559bb5...` | ❌ |
...
* Les preuves complètes se trouvent dans `C:\Trajectoire\certification\runs\788bc00c-20260729T211139Z`.
