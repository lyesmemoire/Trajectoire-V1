...
|----------|------|------------------|--------------|
| mutation-report.json | mutation | `sha256:dc6688e160cbc...` | ❌ |
| coverage-report.json | coverage | `sha256:5d1a43d6b1670...` | ❌ |
...
* Les preuves complètes se trouvent dans `C:\Trajectoire\certification\runs\788bc00c-20260729T195815Z`.
