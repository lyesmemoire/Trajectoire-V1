 ...
 * TODO (Sprint C)
 *
 * Replace full snapshot persistence with incremental persistence.
 *
 * Planned API:
 *
 *   saveInitialSnapshot()
 ...
 *   saveFinalSnapshot()
 *
 * The persistence layer will be responsible for rebuilding the
 * complete session history from incremental snapshots.
 *
 * No Runtime modification must be required.
 */
