...
export class CareerCopilotResourceIntelligenceEngine {
  ...
  static trackResourceEvolution({
    ...
    eventBus.publish({
      ...
      id: `resource_evolution_${Date.now()}`,
      payload: {
        source: "resource_intelligence",
  ...
  static async analyzeResourceIntelligence(
    ...
    const result = await aiOrchestrator.execute(
      careerCopilotResourceIntelligenceV1,
      {
        candidateProfile,
        currentMission,
        recentObservations,
      ...
      },
      {
        ...
        promptId: "career-copilot-resource-intelligence-v1",
      }
    );

    const resourceIntelligence = result.data as ResourceIntelligenceOutput;
    ...
    eventBus.publish({
      type: "observation_created",
      id: `resource_intelligence_${Date.now()}`,
      payload: {
        source: "resource_intelligence",
        observationType: "general",
