...
export class CareerCopilotGapIntelligenceEngine {
    ...
    missingSkills.forEach((skill, index) => {
      ...
      if (directTransfer) {
        gaps.push(this.createGap(
          ...
          true,
          true,
          LEARNING_TIME_ESTIMATES[skill.name.toLowerCase()] || LEARNING_TIME_ESTIMATES["default"],
   ...
   */
  private static identifySoftSkillGaps(matchingCoreContext: MatchingCoreOutput): Gap[] {
    const gaps: Gap[] = [];
    ...
    missingTechs.forEach((tech, index) => {
      ...
      if (directTransfer) {
        gaps.push(this.createGap(
          ...
          true,
          true,
          LEARNING_TIME_ESTIMATES[tech.toLowerCase()] || LEARNING_TIME_ESTIMATES["default"],
   ...
   */
  private static identifyExperienceGaps(matchingCoreContext: MatchingCoreOutput): Gap[] {
    const gaps: Gap[] = [];
   ...
   */
  private static identifyEducationGaps(matchingCoreContext: MatchingCoreOutput): Gap[] {
    const gaps: Gap[] = [];
   ...
   */
  private static identifyLanguageGaps(matchingCoreContext: MatchingCoreOutput): Gap[] {
    const gaps: Gap[] = [];
   ...
   */
  private static identifyBusinessGaps(_matchingCoreContext: MatchingCoreOutput): Gap[] {
    const gaps: Gap[] = [];
   ...
   */
  private static identifyCultureGaps(_matchingCoreContext: MatchingCoreOutput): Gap[] {
    const gaps: Gap[] = [];
   ...
   */
  private static identifyMobilityGaps(_matchingCoreContext: MatchingCoreOutput): Gap[] {
    const gaps: Gap[] = [];
