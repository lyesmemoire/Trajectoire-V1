...
import { Shield, CheckCircle, AlertTriangle, Square, Play } from "lucide-react";
...
export function ModerationSession({
  sessionData,
  onStart,
  onStop,
  onCancel
}: ModerationSessionProps) {
  ...
  return (
    <Card className="bg-white border border-gray-200/60 shadow-sm">
      <CardHeader>
        <CardTitle className="text-gray-900">Moderation Session</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-gray-900">{sessionData.threshold}</div>
            </div>
          </div>
