...
## 6. Reference Implementations (Mise à jour 2025-01-11)
...
Le moteur de préparation d'entretien est une **implémentation de référence** démontrant les meilleures pratiques en :
- Clean Architecture
...
**Documentation**: [Interview Preparation Engine Reference Implementation](docs/architecture/interview-preparation-engine/REFERENCE_IMPLEMENTATION.md)

**Architecture Frozen**: ✅ ARCHITECTURE FROZEN (no modifications except critical production bug fixes)
...
FEATURE_B5 est une implémentation de référence démontrant la persistance runtime Supabase pour les sessions Runtime.

**Documentation**: [FEATURE_B5 Runtime Persistence](docs/FEATURE_B5_RUNTIME_PERSISTENCE.md)

**Architecture Frozen**: ✅ ARCHITECTURE FROZEN (no modifications except critical production bug fixes)

---

## 7. Architecture Master Documentation

**Documentation**: [Master Architecture](docs/MASTER_ARCHITECTURE.md)

Ce document fournit une vue d'ensemble de l'architecture maître pour le projet Trajectoire, incluant toutes les implémentations de référence et les principes architecturaux.

---

## 8. Project Brief

**Documentation**: [Project Brief](docs/PROJECT_BRIEF.md)

Ce document fournit un aperçu du projet Trajectoire, incluant les implémentations de référence, la stack technique, et les principes architecturaux.
