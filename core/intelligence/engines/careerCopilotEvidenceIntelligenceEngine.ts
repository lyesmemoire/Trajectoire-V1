...
export class CareerCopilotEvidenceIntelligenceEngine {
  ...
  static async analyzeEvidenceIntelligence(
    ...
    // Call intelligenceCoreModule with evidence intelligence prompt
    const promptTemplate = careerCopilotEvidenceIntelligenceV1.system || careerCopilotEvidenceIntelligenceV1.user;
    ...
    const output: EvidenceIntelligenceOutput = result.output as EvidenceIntelligenceOutput;
    ...
    // Publish evidence analysis event to EventPublisher
