...
describe("snapshot — S3: Hash stable", () => {
    ...
    it("should produce consistent hash across multiple calls", () => {
        const snap = createSnapshot({ trust: 0.8, suspicion: 0.1, pressure: 20, emotion: "happy" }, 100);
    ...
    it("should return a 64-character hex string (SHA-256)", () => {
        const snap = createSnapshot({ trust: 0.5, suspicion: 0.5, pressure: 50, emotion: "neutral" }, 0);
...
//# sourceMappingURL=snapshot-hash.test.js.map