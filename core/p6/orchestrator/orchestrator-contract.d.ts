...
export interface RuntimeStepFailure {
    sessionId: string;
    reason: "SESSION_NOT_FOUND" | "SESSION_NOT_ACTIVE" | "LIFECYCLE_ERROR" | "EXECUTION_ERROR";
}
export type OrchestratorResult = {
    ok: true;
    value: RuntimeStepResult;
} | {
    ok: false;
    reason: RuntimeStepFailure["reason"];
    sessionId: string;
};
...
//# sourceMappingURL=orchestrator-contract.d.ts.map