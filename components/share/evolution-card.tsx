...
export function EvolutionCard({ from, _to }: Props) {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-[400px] bg-slate-900 rounded-[3rem] p-10 border border-white/5 relative overflow-hidden"
    >
      <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-emerald-500 via-blue-500 to-indigo-600" />
      ...
      <div className="relative z-10 space-y-10">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="text-center space-y-2">
            <motion.div
              ...
              className="w-20 h-20 bg-blue-600 rounded-3xl flex items-center justify-center text-4xl shadow-2xl shadow-blue-600/40"
            >
              {toMeta.icon}
            </motion.div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-slate-400 leading-relaxed font-medium">
            ...
            <span className="text-emerald-400 font-bold">14%</span> et votre
