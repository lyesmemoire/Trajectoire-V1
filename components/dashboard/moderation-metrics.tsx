...
export function ModerationMetrics({ metricsData }: ModerationMetricsProps) {
  return (
    <Card className="bg-white border border-gray-200/60 shadow-sm">
      <CardHeader>
        <CardTitle className="text-gray-900">Moderation Metrics</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-600">Moderation statistics</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <div className="text-xs text-gray-600 mb-1">Total Moderations</div>
              <div className="text-sm font-medium text-gray-900 flex items-center gap-1">
                <Shield className="w-3 h-3 text-blue-600" />
                {metricsData.totalModerations}
              </div>
            </div>
            <div>
              <div className="text-xs text-gray-600 mb-1">Total Texts</div>
              <div className="text-sm font-medium text-gray-900">{metricsData.totalTexts}</div>
            </div>
            <div>
              <div className="text-xs text-gray-600 mb-1">Total Images</div>
              <div className="text-sm font-medium text-gray-900">{metricsData.totalImages}</div>
            </div>
          </div>
