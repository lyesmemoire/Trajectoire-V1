...
export function SpeechSession({
  ...
  return (
    <Card className="bg-white border border-gray-200/60 shadow-sm">
      <CardHeader>
        <CardTitle className="text-gray-900">Speech Session</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div>
              ...
              <div className="text-sm font-medium text-gray-900">{sessionData.format}</div>
            </div>
          </div>

          <div className="pt-3 border-t border-gray-200">
            <div className="text-xs text-gray-600 mb-2">Sample Rate: {sessionData.sampleRate}Hz</div>
