#!/usr/bin/env tsx
/**
 * Script pour corriger tous les imports en double de Transaction
 */
...
async function main() {
  console.log('🔧 Correction des imports en double de Transaction');
  ...
  for (const file of files) {
    ...
    // Supprimer les imports Transaction depuis @/core/p5/timeline/timeline-contract (chemin incorrect)
    const wrongImportRegex = /import\s+{\s*Transaction\s*}\s+from\s+['"]@\/core\/p5\/timeline\/timeline-contract['"]/g;
