#!/usr/bin/env tsx
/**
 * Script pour corriger tous les imports en double de VoiceExecutionPlan
 */
...
async function main() {
  console.log('🔧 Correction des imports en double de VoiceExecutionPlan');
  ...
  for (const file of files) {
    ...
    // Supprimer les imports VoiceExecutionPlan depuis @/core/p7/contracts/voice.contract (chemin incorrect)
    const wrongImportRegex = /import\s+{\s*VoiceExecutionPlan\s*}\s+from\s+['"]@\/core\/p7\/contracts\/voice\.contract['"]/g;
