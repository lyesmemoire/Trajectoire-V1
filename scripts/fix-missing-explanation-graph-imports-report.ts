#!/usr/bin/env tsx
/**
 * Script pour ajouter les imports ExplanationGraph manquants dans les fichiers report
 */
...
async function main() {
  console.log('🔧 Correction des imports ExplanationGraph manquants dans report');
  ...
  for (const file of files) {
    ...
    if (content.includes('ExplanationGraph') && !content.includes('import { ExplanationGraph }')) {
      ...
      const importLine = 'import { ExplanationGraph } from "../../explainability/explanation-contract.js";\n';
