#!/usr/bin/env tsx
/**
 * Script pour corriger tous les imports en double de ExplanationGraph
 */
...
async function main() {
  console.log('🔧 Correction des imports en double de ExplanationGraph');
  ...
  for (const file of files) {
    ...
    // Supprimer les imports ExplanationGraph depuis @/core/p7/contracts/explanation.contract (chemin incorrect)
    const wrongImportRegex = /import\s+{\s*ExplanationGraph\s*}\s+from\s+['"]@\/core\/p7\/contracts\/explanation\.contract['"]/g;
