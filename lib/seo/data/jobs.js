export const jobs = [
    // Engineering
    {
        ...
        level: "mid",
        avgSalary: 55,
        description: "Développeur spécialisé dans les interfaces utilisateur avec React, Vue ou Angular.",
        keywords: [
            "react",
            "vue",
            "angular",
    ...
    },
    {
        ...
        level: "mid",
        avgSalary: 60,
        description: "Développeur côté serveur expert en Node.js, Python, Java ou Go.",
        keywords: [
            "node.js",
            "python",
            "java",
    ...
    },
    {
        ...
        level: "mid",
        avgSalary: 65,
        description: "Ingénieur logiciel généraliste travaillant sur des systèmes complexes.",
        keywords: [
            "algorithms",
            "data structures",
            "system design",
    ...
    // Product
    {
        ...
        level: "senior",
        avgSalary: 75,
        description: "Responsable de la vision produit, de la roadmap et de la stratégie.",
    ...
    },
    {
        ...
        level: "mid",
        avgSalary: 60,
        description: "Interface entre l'équipe dev et les stakeholders, gestion du backlog.",
    ...
    // Data
    {
        ...
        level: "senior",
        avgSalary: 70,
        description: "Expert en machine learning, statistiques et analyse prédictive.",
        keywords: [
            "python",
            "machine learning",
            "statistics",
    ...
    },
    {
        ...
        level: "senior",
        avgSalary: 68,
        description: "Architecte de pipelines de données et d'infrastructures Big Data.",
    ...
    // Design
    {
        ...
        level: "mid",
        avgSalary: 52,
        description: "Conception d'expériences utilisateur basées sur la recherche.",
        keywords: [
            "user research",
            "wireframes",
            "prototyping",
