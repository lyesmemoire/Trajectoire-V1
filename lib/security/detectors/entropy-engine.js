export function calculateEntropyScore(signals) {
    let score = 0;
    // 1. Humain = Mouvements de souris non-linéaires
    if (signals.mouseMovements > 50)
        score += 30;
 ...
 */
export function detectAutomationFingerprint(headers) {
