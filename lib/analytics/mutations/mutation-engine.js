 ...
 */
export function extractNarrativeMutation(user, sessions) {
    ...
    if (currentConfidence > previousConfidence + 15) {
        return {
            ...
            turningPoint: "A cessé de s'excuser après la deuxième interruption de Victor.",
    ...
    if (currentClarity > previousClarity + 10) {
        return {
            ...
            turningPoint: "Victor a validé la structure STAR sur la question complexe.",
