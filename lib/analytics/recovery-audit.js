 ...
 */
export async function computeRecoveryAudit() {
    ...
    const returnAfterRecoveryRate = uniqueUserIds.length > 0 ? (returnedUsers / uniqueUserIds.length) * 100 : 0;
    return {
...
//# sourceMappingURL=recovery-audit.js.map