...
// ── Score sémantique ─────────────────────────────────────
export async function computeSemanticScore(cvText, jobText) {
...
// ── Score mots-clés ──────────────────────────────────────
export function computeKeywordScore(cv, job) {
...
export async function generateFeedback(cvText, jobText) {
...
//# sourceMappingURL=local-ats.js.map