 ...
 */
import { isProductOutput, emptyProductOutput, } from "./product-contract";
import { analyzeKeywords, mapKeywordAnalysisToProductOutput, mergeLlmFeedback, } from "./adapters";
 ...
 */
async function tryEnrich(cvText, jobText) {
    try {
        const mod = await import("@/lib/local-ats");
        if (typeof mod.generateFeedback !== "function")
            return null;
...
export async function runProductFlow(input, options = {}) {
...
//# sourceMappingURL=run-product-flow.js.map