 ...
 */
export function evaluateConfidenceRecovery(_session, currentMetrics) {
    ...
    if (isFrozen) {
        return {
            ...
            newPressure: 20,
            instruction: "Le candidat est en surcharge. Simplifie la question. Sois rassurante et professionnelle.",
        };
    }
    return { active: false };
}
//# sourceMappingURL=confidence-recovery.js.map