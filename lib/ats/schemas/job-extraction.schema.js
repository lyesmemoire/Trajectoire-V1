...
export function normalizeExtractedSkills(skills) {
    return skills.map((skill) => {
        const normalized = Object.entries(SKILL_ALIASES).find(([, aliases]) => aliases.some((alias) => alias.toLowerCase() === skill.toLowerCase()));
        return normalized ? normalized[0] : skill;
    });
}
//# sourceMappingURL=job-extraction.schema.js.map