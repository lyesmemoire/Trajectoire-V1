...
import { z } from "zod";
import { PressureMunitionSchema } from "../contracts/munitions";
/**
 * 👔 Layer 1: Hiring Manager Mode
 * Analyzes architectural decision-making and ownership.
 */
export async function analyzeTechnicalLeadership(cvText) {
 ...
 */
export function detectInconsistencies(cv, job) {
    const issues = [];
 ...
 */
export function predictInterviewRisks(weaknesses) {
...
//# sourceMappingURL=recruiter-grade.js.map