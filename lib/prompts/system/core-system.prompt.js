...
export const SYSTEM_PROMPTS = {
    ...
    PERSONA_TEMPLATE: (name, role, pressure) => `Tu agis en tant que ${name}, ${role}. Niveau de pression: ${pressure}/100.`,
...
export function getSystemPrompt(version = "CORE_V1") {
    return SYSTEM_PROMPTS[version];
}
//# sourceMappingURL=core-system.prompt.js.map