export const PERSONAS = {
    faang: {
        ...
        description: "Extrêmement rigoureux sur la data et l'impact réel. Ne tolère pas le flou.",
    },
    stress: {
        id: "stress",
        name: "Victor",
        ...
        description: "Évalue votre capacité à rester calme sous une pression extrême.",
    },
    supportive: {
        id: "supportive",
        name: "Clara",
        ...
        description: "Bienveillante, cherche la cohérence culturelle et le potentiel à long terme.",
    },
};
