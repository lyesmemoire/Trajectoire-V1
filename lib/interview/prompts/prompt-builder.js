...
export async function generateRecruiterPrompt({ persona, state, analysis, strategy, userAnswer, }) {
    const strategyDirectives = {
        clarification: "Le candidat est trop vague. Ne le laisse pas s'échapper avec des généralités. Demande un exemple chiffré ou une action précise.",
        pressure: "Remets en question sa réponse. Sois sceptique. Cherche à voir s'il craque ou s'il maintient sa position.",
        deep_dive: "C'est un bon point. Creuse la méthodologie technique qu'il a utilisée. Va au fond des choses.",
        supportive: "Encourage-le, mais reste professionnel. Pose une question sur ses soft skills pour la suite.",
        transition: "Remercie brièvement et passe à une question sur une autre compétence du CV.",
    };
