 ...
 */
export function evaluateInterruption(signals, currentPressure, persona) {
    ...
    let impatienceScore = signals.ramblingScore * 0.6 + (100 - signals.specificity) * 0.4;
    ...
    const shouldInterrupt = impatienceScore > baseThreshold &&
 ...
 */
export function getInterruptionPhrase(type, persona) {
    const styles = {
        stress: {
            clarify: [
                "Soyez plus concret.",
...
//# sourceMappingURL=interruption-engine.js.map