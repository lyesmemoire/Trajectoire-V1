export function buildSystemPrompt(persona, state, strategy) {
    const strategyPrompts = {
        clarification: "Demande plus de précisions sur un point flou de la réponse précédente.",
        pressure: "Remets en question la validité ou l'impact de la réponse précédente. Sois direct et un peu froid.",
        deep_dive: "Le candidat a mentionné un point intéressant. Creuse cet aspect technique ou méthodologique.",
        contradiction: "Propose un point de vue opposé pour voir comment le candidat défend ses idées.",
        supportive: "Valide positivement la réponse et pose une question ouverte pour la suite.",
    };
