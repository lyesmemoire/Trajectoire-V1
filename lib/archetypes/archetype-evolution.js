...
import { determineArchetype } from "./archetype-engine";
export async function updateArchetypeEvolution(userId, latestScores) {
    ...
    const history = profile.careerDNA?.archetypeHistory || [];
    const previousArchetype = history.length > 0 ? history[history.length - 1].type : null;
    const newEntry = {
...
//# sourceMappingURL=archetype-evolution.js.map