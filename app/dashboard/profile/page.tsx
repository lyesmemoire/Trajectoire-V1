...
import { User, Mail, Phone, MapPin, Briefcase, Save, Bell, Lock, Shield, CheckCircle2 } from "lucide-react";
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input placeholder="Jean" defaultValue="Jean" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-900">Nom</label>
                <Input placeholder="Dupont" defaultValue="Dupont" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input type="email" placeholder="jean.dupont@email.com" defaultValue="jean.dupont@email.com" disabled />
            ...
            <div className="space-y-2">
              ...
              <Input type="tel" placeholder="+33 6 12 34 56 78" defaultValue="+33 6 12 34 56 78" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input placeholder="Paris, France" defaultValue="Paris, France" />
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <Input placeholder="Senior Product Manager" defaultValue="Senior Product Manager" />
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-900">Entreprise</label>
              <Input placeholder="TechCorp" defaultValue="TechCorp" />
            </div>

            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-900">LinkedIn</label>
              <Input placeholder="linkedin.com/in/jeandupont" defaultValue="linkedin.com/in/jeandupont" />
            </div>
          </div>
        </CardContent>
      </Card>
