    ...
    <div className="max-w-5xl mx-auto pb-24 space-y-10">
      ...
      <div className="grid lg:grid-cols-12 gap-8">
            ...
            <CardContent className="p-8 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 font-medium text-text outline-none focus:border-primary transition-colors"
                >
                  {cvs.map((cv) => (
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full h-64 p-4 rounded-xl border border-gray-200 bg-gray-50 focus:border-primary outline-none text-text font-medium resize-none leading-relaxed transition-colors"
                />
              ...
              <Button
                ...
                className="w-full py-6 rounded-xl text-lg h-auto"
                size="lg"
              >
                {isPending ? (
        ...
        <div className="lg:col-span-7">
          ...
          {isPending && (
            <Card variant="elevated">
              <CardContent className="flex flex-col items-center justify-center py-24 space-y-4">
                ...
                <p className="text-text-muted font-medium text-sm uppercase tracking-wider">
                  Analyse en cours...
                </p>
              </CardContent>
            </Card>
          ...
          {result && <ResultDisplay result={result} cvId={selectedCvId} />}
        </div>
      </div>
    </div>
  );
