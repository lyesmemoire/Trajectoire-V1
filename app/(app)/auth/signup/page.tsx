...
function SignupForm() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // ✅ 1. Get Device Fingerprint dynamically
      const fpPromise = import("@fingerprintjs/fingerprintjs").then(mod => mod.default || mod);
  ...
  const handleOAuth = async (provider: "google" | "microsoft") => {
    ...
    // OAuth requires client-side redirect - this is standard for OAuth flows
    // The client-side Supabase SDK handles the OAuth redirect flow
    ...
    return (
      <div className="min-h-screen flex" style={{ backgroundColor: "#F8F6F3" }}>
        ...
        <div className="w-full lg:w-[55%] flex items-center justify-center p-6 lg:p-12">
          <div
            className="w-full max-w-[480px] animate-in fade-in slide-in-from-bottom-4 duration-500"
          >
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: "#F8F6F3" }}>
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden items-end">
        <div
          className="absolute inset-0 animate-in fade-in zoom-in-105 duration-1000 fill-mode-forwards"
        >
          <Image
        ...
        <div
          className="relative z-20 p-12 text-white animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500 fill-mode-both"
        >
