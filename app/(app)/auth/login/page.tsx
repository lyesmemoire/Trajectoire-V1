    ...
    try {
      ...
      if (!response.ok) {
        if (data.code === "UNAUTHORIZED") {
          if (data.error.includes("confirmer")) {
        ...
        <div className="w-full max-w-[440px]">
          ...
          >
            <Card className="p-10 lg:p-12 shadow-sm border border-gray-200/60 bg-white/80 backdrop-blur-sm">
              ...
              {resendSuccess && (
                <div
                  className="mb-6 p-4 bg-green-50/80 border border-green-200/60 rounded-lg flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300"
                >
              ...
              {error && (
                <div
                  className="mb-6 p-4 bg-red-50/80 border border-red-200/60 rounded-lg flex flex-col gap-3 animate-in fade-in slide-in-from-top-2 duration-300"
                >
