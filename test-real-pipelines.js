...
class RealPipelineTester {
  ...
  async testDatabaseConnectivity() {
    ...
    try {
      ...
      this.errors.set('database', error);
      console.error('❌ Database connection failed:', error);
    }
  }

  async testCreateRealUser() {
    ...
    try {
      ...
      this.errors.set('user', error);
      console.error('❌ User creation failed:', error);
    }
  }

  async testCreateRealCV() {
    ...
    try {
      ...
      this.errors.set('cv', error);
      console.error('❌ CV creation failed:', error);
    }
  }

  async testCreateRealJob() {
    ...
    try {
      ...
      this.errors.set('job', error);
      console.error('❌ Job creation failed:', error);
    }
  }

  async testCreateRealSession() {
    ...
    try {
      ...
      this.errors.set('session', error);
      console.error('❌ Session creation failed:', error);
    }
  }

  async testRealMatching() {
    ...
    try {
      ...
      this.errors.set('matching', error);
  ...
  async testOpenTelemetry() {
    ...
    try {
      ...
      this.errors.set('openTelemetry', error);
  ...
  async testMetrics() {
    ...
    try {
      ...
      if (!posthogKey || posthogKey === 'dummy') {
      ...
      this.errors.set('metrics', error);
      console.error('❌ Metrics failed:', error);
    }
  }

  async testStripeSandbox() {
