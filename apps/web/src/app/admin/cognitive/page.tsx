  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Cognitive Intelligence Dashboard</h1>
          <p className="text-slate-600 mt-1">Real-time monitoring of cognitive systems</p>
        </div>
        <div className="flex gap-2">
          <span className={`px-3 py-1 rounded-full text-sm font-medium ${
            latestReport?.healthStatus === "healthy" ? "bg-green-100 text-green-700" :
            latestReport?.healthStatus === "degraded" ? "bg-yellow-100 text-yellow-700" :
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-2">World Model</h3>
        ...
        {/* Reasoning Engine */}
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Reasoning Engine</h3>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
        ...
        {/* Reflection Engine */}
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Reflection Engine</h3>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Multi-Agent Collaboration</h3>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-slate-600">Avg Priority</span>
        ...
        {/* Hierarchical Memory */}
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Hierarchical Memory</h3>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-slate-600">Memory Links</span>
              <span className="font-medium">{memoryStats.totalLinks}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-slate-600">Consolidations</span>
              <span className="font-medium">{memoryStats.totalConsolidations}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-slate-600">Avg Importance</span>
        ...
        {/* Meta Cognition */}
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-2">Meta Cognition</h3>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-slate-600">Total Reports</span>
            ...
            <div className="flex justify-between text-sm">
              <span className="text-slate-600">Avg Health</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Reasoning Stage Distribution</h3>
          <div className="space-y-3">
            {Object.entries(reasoningStats.stageDistribution).map(([stage, count]) => (
              <div key={stage} className="flex items-center gap-3">
                <div className="w-32 text-sm text-slate-600 capitalize">{stage.replace(/_/g, " ")}</div>
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Insight Distribution</h3>
          <div className="space-y-3">
            {Object.entries(reflectionStats.insightDistribution).map(([type, count]) => (
              <div key={type} className="flex items-center gap-3">
                <div className="w-32 text-sm text-slate-600 capitalize">{type.replace(/_/g, " ")}</div>
                <div className="flex-1 bg-slate-100 rounded-full h-2">
                  <div
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Memory Type Distribution</h3>
          <div className="space-y-3">
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Learning Event Distribution</h3>
          <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Improvement Proposals</h3>
              ...
              {latestReport.improvementProposals.slice(0, 5).map((proposal) => (
                <div key={proposal.id} className="p-3 bg-blue-50 rounded-lg border border-blue-100">
                  <div className="flex justify-between items-start mb-1">
                    <span className="text-sm font-medium text-blue-900 capitalize">{proposal.metricType.replace(/_/g, " ")}</span>
                  ...
                  <p className="text-xs text-blue-600 mt-1">Priority: {proposal.priority}</p>
                </div>
              ))}
            </div>
          ) : (
      ...
      <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
        ...
        <p className="text-sm text-slate-600">{latestReport?.summary || "No summary available"}</p>
      </div>
    </div>
  );
}
