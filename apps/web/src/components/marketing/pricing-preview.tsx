      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center space-y-16">
        <div className="text-center space-y-6">
          <h2 className="text-4xl lg:text-7xl font-black text-white leading-tight tracking-tighter">
            ...
            <span className="text-bronze-600 italic">votre transformation.</span>
          </h2>
          <p className="text-xl text-ink-500 font-medium max-w-xl mx-auto">
        ...
        <motion.div
          whileHover={{ y: -10 }}
          className="w-full max-w-lg bg-[#0B1023] rounded-[3.5rem] border-2 border-bronze-600 shadow-[0_0_50px_rgba(166,124,61,0.15)] p-12 relative overflow-hidden"
        >
          ...
          <div className="space-y-8 relative z-10">
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-sm font-bold text-bronze-400 uppercase tracking-widest mt-1">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li
                  key={f}
                  className="flex items-center gap-3 text-ink-300 font-medium"
                >
                  <Check className="w-5 h-5 text-bronze-500 flex-shrink-0" /> {f}
                </li>
              ))}
            </ul>
            ...
            <div className="pt-8 border-t border-white/5 space-y-4">
              ...
              <Link
                href="/pricing"
                className="block text-center text-[10px] font-black text-ink-500 uppercase tracking-widest hover:text-white transition-colors"
              >
