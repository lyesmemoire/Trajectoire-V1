...
export function FinalCTA() {
  return (
    <section className="section px-6 bg-ink-900 relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-bronze-600/10 rounded-full blur-[160px] -z-10" />
      ...
      <div className="max-w-5xl mx-auto text-center space-y-16">
        ...
        >
          Pouvez-vous <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-bronze-400 to-ink-300">
            dominer l'arène ?
          </span>
        </motion.h2>

        <p className="text-2xl text-ink-400 font-medium max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="flex items-center justify-center gap-6 pt-12">
          <div className="flex items-center gap-2">
            <Zap className="w-4 h-4 text-terracotta-500 fill-terracotta-500" />
