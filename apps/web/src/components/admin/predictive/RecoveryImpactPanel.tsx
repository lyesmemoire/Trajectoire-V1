...
export function RecoveryImpactPanel({ data }: Props) {
  return (
    <div className="bg-white rounded-[3rem] border border-ivoire-100 p-10 shadow-sm space-y-10">
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 bg-bronze-50 rounded-2xl flex items-center justify-center text-bronze-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        ...
        <div className="space-y-2">
          <p className="text-[10px] font-black text-bronze-600 uppercase tracking-widest">
            Success Rate
          </p>
          <p className="text-4xl font-black text-forest-600">
            {data.recoveryReturnRate}%
          </p>
        </div>
      </div>

      <div className="p-8 bg-ink-900 rounded-[2.5rem] text-white space-y-4">
        <div className="flex items-center gap-3">
        ...
        <p className="text-sm font-medium text-ink-300 leading-relaxed italic">
