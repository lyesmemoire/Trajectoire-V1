  ...
  return (
    <div className="bg-white rounded-[3rem] p-10 border border-ivoire-100 shadow-xl max-w-md mx-auto text-center space-y-8">
      ...
      <div className="relative flex items-center justify-center h-32">
        {status === "idle" && (
          <div className="w-20 h-20 bg-ivoire-50 rounded-full flex items-center justify-center text-ink-300">
        ...
        {status === "testing" && (
          <div className="relative flex items-center justify-center">
            <motion.div
              ...
              className="w-20 h-20 bg-ivoire-50 rounded-full flex items-center justify-center text-ink-600"
            >
              <Mic className="w-8 h-8" />
            </motion.div>
            <p className="absolute -bottom-8 text-[10px] font-black text-ink-600 uppercase tracking-widest">
              Parlez maintenant...
            </p>
          </div>
        )}
        {status === "success" && (
          <div className="w-20 h-20 bg-forest-100 rounded-full flex items-center justify-center text-forest-600">
            <CheckCircle2 className="w-10 h-10" />
          </div>
        )}
        {status === "error" && (
          <div className="w-20 h-20 bg-brick-100 rounded-full flex items-center justify-center text-brick-600">
      ...
      {status === "success" ? (
        <p className="text-forest-600 font-black uppercase text-xs tracking-widest">
