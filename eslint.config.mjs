 ...
 */
{
  ...
  rules: {
    "no-restricted-imports": ["error", {
      patterns: [
        {
          group: ["@/core/intelligence/**", "@/core/ai/**", "@/core/prompts/**", "@/core/providers/**"],
          message: "L'IA est strictement réservée au backend. Utilisez une Server Action ou une Route API."
        }
      ]
    }]
  }
